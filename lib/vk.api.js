...
function VkQuery(session)
{
            ...
            if (response.error) {
                ...
                switch (error.code) {
                    case 6: // Too many requests per second.
                        setTimeout(function () { that.call(method, params, callbacks, 2 * retry_timeout); }, retry_timeout);
                        break;
    ...
    var refresh_session_and_call = function (method, params, callbacks, forget_session_on_timeout)
    {
        ...
        var session_updated_listener = function () {
            ...
            that.call(method, params, callbacks, undefined, false); // Error will be thrown, if session was not refreshed and was forgotten.
        };
